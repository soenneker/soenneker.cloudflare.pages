...
public interface ICloudflarePagesUtil
{
    ...
    ValueTask<PagesProject> Create(string accountId, string projectName, string productionBranch, string? buildCommand, string? buildOutputDir, bool deployNow = false, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token.</param>
    /// <returns>The created Pages project response.</returns>
    ValueTask<PagesProject> CreateWithGitHub(string accountId, string projectName, string repoOwner, string repoName,
    ...
    ValueTask<PagesProject> Get(string accountId, string name, CancellationToken cancellationToken = default);
    ...
    ValueTask<PagesProject> Update(string accountId, string name, string productionBranch, CancellationToken cancellationToken = default);
    ...
    ValueTask<List<PagesProject>> List(string accountId, CancellationToken cancellationToken = default);
    ...
    ValueTask<PagesDomain> AddCustomDomain(string accountId, string projectName, string zoneDomain, string customDomain, CancellationToken cancellationToken = default);
    ...
    ValueTask<List<PagesDomain>> ListCustomDomains(string accountId, string projectName, CancellationToken cancellationToken = default);
    ...
    /// <param name="cancellationToken">Optional cancellation token.</param>
    /// <returns>The updated Pages project response.</returns>
    ValueTask<PagesProject> UpdateGitHubConfig(string accountId, string projectName, string repoOwner, string repoName,
    ...
    ValueTask<PagesSource?> GetGitHubConfig(string accountId, string projectName, CancellationToken cancellationToken = default);
    ...
    ValueTask<PagesDeployment> CreateDeployment(string accountId, string projectName, string branch, CancellationToken cancellationToken = default);
}
